...
<head>
    ...
    <script src="js/clone_input.js"></script>
</head>
<body>
    ...
    <section class="container form-group">
        <form action="#" method="get">
            ...
            <input type="text" name="option_3" placeholder="Poll option" maxlength="200" tabindex="1" value autocomplete="off" class="form-control" id="option_3"><br>
